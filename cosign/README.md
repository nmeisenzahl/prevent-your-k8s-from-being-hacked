...
```bash
kubectl apply -f cosign/src/enforce-signed-keyless-policy.yaml

kubectl run --image=cgr.dev/chainguard/nginx:latest
...
kubectl run --image=ghcr.io/nmeisenzahl/prevent-your-k8s-from-being-hacked/hello-app:latest hello-app
